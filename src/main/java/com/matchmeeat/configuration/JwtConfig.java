...
public class JwtConfig {
    ...
    @Bean
    public JwtService jwtService(@Value("${spring.application.name}") String appName, JwtEncoder jwtEncoder, RoleService roleService) {
        return new JwtService(appName, ttl, jwtEncoder, roleService);
    }
}
