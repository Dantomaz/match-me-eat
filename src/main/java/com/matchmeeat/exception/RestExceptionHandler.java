...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<ProblemDetail> handleRefreshTokenExpired(Exception exception, ServletWebRequest request) {
        return createProblemDetailResponseEntity(HttpStatus.UNAUTHORIZED, exception, request);
    }

    @ExceptionHandler(RefreshTokenRevokedException.class)
    protected ResponseEntity<ProblemDetail> handleRefreshTokenRevoked(Exception exception, ServletWebRequest request) {
        return createProblemDetailResponseEntity(HttpStatus.UNAUTHORIZED, exception, request);
    }

    @ExceptionHandler(InvalidRefreshTokenException.class)
    protected ResponseEntity<ProblemDetail> handleInvalidRefreshToken(Exception exception, ServletWebRequest request) {
        return createProblemDetailResponseEntity(HttpStatus.UNAUTHORIZED, exception, request);
    }
